...
public class ConfigManager {
    ...
    public void setEnabled(boolean b) {
        ChatSaver.getSettings().setEnabled(b);
        ChatSaver.getConfig().get("Enabled", "Enabled", true).set(b);
        ChatSaver.getConfig().save();
    }

    /**
     * Sets if the mod should send notifications or not
     *
     * @param b Boolean to set
     */
    public void setNotifications(boolean b) {
        ChatSaver.getSettings().setNotifications(b);
        ChatSaver.getConfig().get("Enabled", "Notifications", true).set(b);
        ChatSaver.getConfig().save();
    }
