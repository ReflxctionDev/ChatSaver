...
public class Reference {
    ...
    public static final String MOD_ID = "chatsaver";

    // Mod name
    public static final String NAME = "ChatSaver";
    ...
    public static final String SERVER_PROXY = "net.reflxction.chatsaver.proxy.ServerProxy";
}
